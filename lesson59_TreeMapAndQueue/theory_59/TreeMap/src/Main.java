...
public class Main {
    public static void main(String[] args) {
        ...
        telephoneBook.put(new Contact("Ilona", "Ivanova"), "+49123456789");
        telephoneBook.put(new Contact("Amina", "Zolotoverkh"), "+3986465757757");
        telephoneBook.put(new Contact("Nataliia", "Didenko"), "+3998767576555");
        telephoneBook.put(new Contact("Nataliia", "Antonuk"), "+399876757788");
